            ...
            <div className="bg-gray-800/60 backdrop-blur-xl border border-gray-700/40 rounded-2xl p-6 shadow-lg space-y-6 text-sm text-gray-400 leading-relaxed">
                ...
                <section className="space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>
                            <span className="text-gray-300">Sensor &amp; switch data</span> — kept for as long as you own the device. If you cancel or downgrade and a device exceeds your capacity, we suspend your access to it but keep recording its readings so that, when you return — for example after a seasonal break — your full history is intact and you can compare it year over year. <span className="text-gray-300">If you turn off retention</span> for your data (from your <Link href="/profile" className="text-sky-400 hover:text-sky-300">profile</Link>) and then have no active subscription, your suspended devices are removed from your account after 6 months and their readings are permanently deleted or irreversibly anonymized (stripped of any link to you or the device) and kept only as anonymized data to improve the service. You can remove a device or export its data at any time. When you sell or unclaim a device, or delete your account, the same applies: your readings are anonymized or deleted, never kept linked to you and never visible to a later owner.
                        </li>
                        ...
                        <li><span className="text-gray-300">Database backups</span> — 3 daily, 4 weekly, 6 monthly snapshots, encrypted at rest. After account deletion, residual data may persist in backups for up to about 6 months until rotation completes; backups are not used for any processing.</li>
                    </ul>
