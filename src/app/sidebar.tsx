...
import { HomeIcon, SignalIcon, BoltIcon, PlusCircleIcon, BuildingStorefrontIcon } from '@heroicons/react/24/outline';
                ...
                <ul className="w-full">
                    ...
                    <li>
                        <Link href="/shop" passHref>
                            <div className="block text-gray-200 hover:text-white p-2 flex flex-col items-center justify-center cursor-pointer">
                                <BuildingStorefrontIcon className="h-8 w-8 mb-2 md:mb-0" />
